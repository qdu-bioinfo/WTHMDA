...
def get_microbe_feat(args):
    ...
    M_feat = pd.read_csv(args.mis, header=None)
    ...
    edge_init.to_csv('data/mediumfiles/microbe_func_edge.csv', index=False)
    dataW = pd.read_csv('data/mediumfiles/microbe_func_edge.csv')
    with open('data/mediumfiles/microbe_func_edge.txt', 'w+', encoding = 'utf_8') as f:
    ...
    edge_file = 'data/mediumfiles/microbe_func_edge.txt'
    ...
    wdeepwalk128.to_csv('data/mediumfiles/microbe_feature.csv', index=False)
