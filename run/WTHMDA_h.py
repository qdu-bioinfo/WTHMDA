...
def WTHMDA_h(dm_path,mm_path,dd_path,jc_path,lc_path,wp_path,lin_path,rank_path,disease_features_path,microbe_features_path,name):
    def setup_seed(seed):              
...
if __name__ == "__main__":
    ...
    microbe_features_path = '../data/HMDAD/microbe_feature.csv'
    name = '../result/result_hmdad'
    WTHMDA_h(dm_path,mm_path,dd_path,jc_path,lc_path,wp_path,lin_path,rank_path,disease_features_path,microbe_features_path,name)
    print('WTHMDA_h')
# In[ ]:
