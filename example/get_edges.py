...
def get_edges(MicroPd_path):
    ...
    selfLoop_tree.to_csv('data/example/tree_edge.csv', index=False)
    LC_W.to_csv('data/example/LC_edge.csv', index=False)
    WP_W.to_csv('data/example/WP_edge.csv', index=False)
    Lin_W.to_csv('data/example/Lin_edge.csv', index=False)
    JC_W.to_csv('data/example/JC_edge.csv', index=False)
    print('get_edges done')

if __name__ == "__main__":
    MicroPd_path = 'data/example/microbe_list.xlsx'
