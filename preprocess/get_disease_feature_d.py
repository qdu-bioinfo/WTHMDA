...
def get_disease_feature_d(D_feat_path):
    # In[ ]:
    ...
    #D_feat = pd.read_csv('data/Disbiome/disease_I_S.csv', header=None)
...
if __name__ == "__main__":
    D_feat_path = 'data/Disbiome/disease_I_S.csv'
    get_disease_feature_d(D_feat_path)
    print('get_disease_feature_d done')