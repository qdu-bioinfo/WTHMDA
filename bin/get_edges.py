...
def get_edge(args):
    ...
    MicroPd = pd.read_excel(args.mlist,header=None )
    ...
    selfLoop_tree.to_csv('data/mediumfiles/tree_edge.csv', index=False)
    LC_W.to_csv('data/mediumfiles/LC_edge.csv', index=False)
    WP_W.to_csv('data/mediumfiles/WP_edge.csv', index=False)
    Lin_W.to_csv('data/mediumfiles/Lin_edge.csv', index=False)
    JC_W.to_csv('data/mediumfiles/JC_edge.csv', index=False)
