...
def WTHMDA_run(args):
    ...
    mm_path = 'data/mediumfiles/microbe_func_edge.csv'
    dd_path = 'data/mediumfiles/disease_func_edge.csv'
    jc_path = 'data/mediumfiles/JC_edge.csv'
    lc_path = 'data/mediumfiles/LC_edge.csv'
    wp_path = 'data/mediumfiles/WP_edge.csv'
    lin_path = 'data/mediumfiles/Lin_edge.csv'
    rank_path = 'data/mediumfiles/tree_edge.csv'
    disease_features_path = 'data/mediumfiles/disease_feature.csv'
    microbe_features_path = 'data/mediumfiles/microbe_feature.csv'
    ...
    train_edge = pd.read_csv(args.train)
    test_edge = pd.read_csv(args.test)
    ...
    print('valid : aurocc and auprc', list(valid_auc_df.mean()))
...
def main():
    args = parse_args()
    if not os.path.exists(args.o+"/result/"):
        os.makedirs(args.o+"/result/")
    WTHMDA_run(args)
